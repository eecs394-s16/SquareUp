angular
	...
	$scope.doRefresh = function(){
		...
		var PurchaseRef = new Firebase('https://boiling-torch-3709.firebaseio.com/purchases/'.concat(purchID.key()));
	    ...
	    var creditRef = new Firebase('https://boiling-torch-3709.firebaseio.com/purchases');
	    creditRef.orderByChild("buyer").equalTo("chris3").on("child_added",addCredits);

	    var debtRef = new Firebase('https://boiling-torch-3709.firebaseio.com/profiles/chris3/partyToPurchase');
